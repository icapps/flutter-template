...
class LocalizationOverridesImpl extends LocalizationOverrides {
  @override
  Future<Map<String, dynamic>> getOverriddenLocalizations(Locale locale) async => remoteConfig.overriddenTranslations.map<String, String>((key, value) => MapEntry(key, value.fromLocale(locale) ?? value.en ?? ''));
