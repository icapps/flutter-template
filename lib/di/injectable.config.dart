...
import 'package:flutter_template/di/injectable.dart' as _i52;
...
import 'package:flutter_template/viewmodel/log_detail/log_detail_viewmodel.dart'
    as _i35;
import 'package:flutter_template/viewmodel/login/login_viewmodel.dart' as _i47;
...
import 'package:flutter_template/webservice/todo/todo_webservice.dart' as _i51;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> initGetIt({
    ...
    gh.lazySingleton<_i29.SecureLogStorage>(
        () => registerModule.provideSecureLogStorage(gh<_i20.SecureStorage>()));
    ...
    gh.factory<_i35.LogDetailViewModel>(
        () => _i35.LogDetailViewModel(gh<_i29.SecureLogStorage>()));
    ...
    gh.factory<_i47.LoginViewModel>(() => _i47.LoginViewModel(
          gh<_i36.LoginRepository>(),
          gh<_i15.MainNavigator>(),
          gh<_i39.OnboardingNavigator>(),
        ));
    gh.singleton<_i48.NetworkRefreshInterceptor>(
        () => _i48.NetworkRefreshInterceptor(
              gh<_i31.AuthStorage>(),
    ...
    gh.lazySingleton<_i5.CombiningSmartInterceptor>(
        () => registerModule.provideCombiningSmartInterceptor(
              ...
              gh<_i48.NetworkRefreshInterceptor>(),
            ));
    ...
    gh.singleton<_i24.TodoService>(
      () => _i51.TodoWebService(gh<_i50.Dio>()),
      registerFor: {
        _dev,
        _prod,
      },
