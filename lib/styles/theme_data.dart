...
class FlutterTemplateTheme {
  ...
  static const _instanceDark = FlutterTemplateTheme._(
    darkTextTheme: FlutterTemplateTextTheme(
      titleHuge: TextStyle(fontSize: 40, color: ThemeColors.black, fontFamily: ThemeFonts.OpenSans2, height: 1.2),
      titleBig: TextStyle(fontSize: 30, color: ThemeColors.black, fontFamily: ThemeFonts.OpenSans2, height: 1.2),
      titleNormal: TextStyle(fontSize: 24, color: ThemeColors.black, fontFamily: ThemeFonts.OpenSans2),
      titleSmall: TextStyle(fontSize: 18, color: ThemeColors.black, fontFamily: ThemeFonts.OpenSans2),
