...
import 'package:flutter_template/database/flutter_template_database.dart'
    as _i11;
import 'package:flutter_template/database/todo/todo_dao_storage.dart' as _i25;
import 'package:flutter_template/navigator/main_navigator.dart' as _i19;
...
import 'package:flutter_template/repository/shared_prefs/local/local_storage.dart'
    as _i14;
import 'package:flutter_template/repository/todo/todo_repository.dart' as _i27;
import 'package:flutter_template/util/locale/localization.dart' as _i16;
...
import 'package:flutter_template/viewmodel/license/license_viewmodel.dart'
    as _i13;
import 'package:flutter_template/viewmodel/login/login_viewmodel.dart' as _i18;
...
import 'package:flutter_template/viewmodel/todo/todo_list/todo_list_viewmodel.dart'
    as _i26;
import 'package:flutter_template/webservice/todo/todo_service.dart' as _i28;
...
import 'test_injectable.dart' as _i29;
...
_i1.GetIt $initTestGetIt(
  ...
  gh.singleton<_i16.Localization>(registerModule.getLocalization);
  gh.singleton<_i17.LoginRepository>(registerModule.getLoginRepo);
  gh.singleton<_i18.LoginViewModel>(registerModule.getLoginViewModel);
  gh.singleton<_i19.MainNavigator>(
    registerModule.getMainNavigator,
    registerFor: {_test},
  );
  gh.singleton<_i20.RefreshRepository>(registerModule.getRefreshRepo);
  gh.singleton<_i21.SecureStorage>(registerModule.getSecureStoring);
  gh.singleton<_i4.SharedPreferenceStorage>(
      registerModule.getSharedPrefsStoring);
  gh.singleton<_i22.SharedPreferences>(registerModule.getSharedPreferences);
  gh.singleton<_i23.SplashViewModel>(registerModule.getSplashViewModel);
  gh.singleton<_i24.TodoAddViewModel>(registerModule.getTodoAddViewModel);
  gh.singleton<_i25.TodoDaoStorage>(registerModule.getTodoDaoStoring);
  gh.singleton<_i26.TodoListViewModel>(registerModule.getTodoListViewModel);
  gh.singleton<_i27.TodoRepository>(registerModule.getTodoRepo);
  gh.singleton<_i28.TodoService>(registerModule.getTodoService);
  return get;
}
