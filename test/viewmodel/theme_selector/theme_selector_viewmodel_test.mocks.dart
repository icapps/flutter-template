...
import 'package:flutter_template/navigator/main_navigator.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockMainNavigator extends _i1.Mock implements _i8.MainNavigator {
  MockMainNavigator() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<void> goToDatabase(_i9.GeneratedDatabase? db) =>
      (super.noSuchMethod(
        Invocation.method(
          #goToDatabase,
          [db],
